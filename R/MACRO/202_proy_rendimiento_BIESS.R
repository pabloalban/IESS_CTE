...
n = parametros$horizonte #Número de años a predecir
...
anio_fin <- parametros$anio_ini + parametros$horizonte 
predicciones_mensuales_biess <-   cbind( expand.grid( mes = c( 1:12 ), anio = c( anio_ini:anio_fin ) ),
                                   forecast ) %>% 
